...
struct JSONPointerTests {
    ...
    func resolveTopLevel() {
        let data: StructuredValue = .object(["name": .string("Alice"), "age": .int(30)])
    ...
    func resolveArrayIndex() {
        let data: StructuredValue = .object(["items": .array([.string("x"), .string("y"), .string("z")])])
    ...
    func resolveNonExistent() {
        let data: StructuredValue = .object(["a": .string("b")])
    ...
    func resolveOutOfBounds() {
        let data: StructuredValue = .array([.int(1), .int(2)])
    ...
    func resolveEmptyPath() {
        let data: StructuredValue = .string("root-value")
    ...
    func setTopLevel() {
        var data: StructuredValue = .object(["x": .int(1)])
    ...
    func setEmptyPathReplacesRoot() {
        var data: StructuredValue = .object(["old": .bool(true)])
    ...
    func setArrayElement() {
        var data: StructuredValue = .object(["list": .array([.int(1), .int(2), .int(3)])])
    ...
    func removeTopLevel() {
        var data: StructuredValue = .object(["a": .int(1), "b": .int(2)])
    ...
    func removeNonExistentIsNoOp() {
        var data: StructuredValue = .object(["a": .int(1)])
    ...
    func escapeSlash() {
        let data: StructuredValue = .object(["a/b": .string("slash")])
    ...
    func escapeTilde() {
        let data: StructuredValue = .object(["a~b": .string("tilde")])
...
struct ComponentTreeResolverTests {
    ...
    func simpleTree() throws {
        let components: [String: StructuredValue] = [
    ...
    func depthLimit() throws {
        ...
        var components: [String: StructuredValue] = [:]
...
struct ComponentValidatorTests {
    ...
    func validComponents() throws {
        ...
        let topologyComponents: [String: StructuredValue] = [
